...
** Archivo constant_operand.h: Archivo de la clase especifica de operando constante
**
** Referencias:
**      Enlaces de interes
...
#ifndef CONSTANT_OPERAND_H
#define CONSTANT_OPERAND_H

#include "operand.h"

class ConstantOperand : public Operand {
 public:
  explicit ConstantOperand(int value);  
